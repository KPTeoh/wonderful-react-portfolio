...
const projects = [
  {
    ...
    description:
      "A platform to allow users to buy or view items via retail sales through online marketplaces and websites",
    image: "/projects/coming-soon.jpg",
    tags: ["Nextjs", "React", "TailwindCSS", "Payload", "Stripe"],
    demoUrl: "#",
    githubUrl: "#",
  },
    {
